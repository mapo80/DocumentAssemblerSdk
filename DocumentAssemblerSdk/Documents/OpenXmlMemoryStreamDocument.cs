    ...
    public class OpenXmlMemoryStreamDocument : IDisposable
    {
        ...
        public static OpenXmlMemoryStreamDocument CreateWordprocessingDocument()
        {
            ...
            if (doc.MainDocumentPart == null)
                throw new PowerToolsDocumentException("Failed to create MainDocumentPart.");
        ...
        public static OpenXmlMemoryStreamDocument CreateSpreadsheetDocument()
        {
            ...
            if (doc.WorkbookPart == null)
                throw new PowerToolsDocumentException("Failed to create WorkbookPart.");
        ...
        public static OpenXmlMemoryStreamDocument CreatePresentationDocument()
        {
            ...
            if (doc.PresentationPart == null)
                throw new PowerToolsDocumentException("Failed to create PresentationPart.");
        ...
        {
            if (DocPackage == null)
                throw new PowerToolsDocumentException("Package is not available.");
            return DocPackage;
        }
        ...
        public OpenXmlPowerToolsDocument GetModifiedDocument()
        {
            ...
            if (DocMemoryStream == null)
                throw new PowerToolsDocumentException("Memory stream is not available.");
            return new OpenXmlPowerToolsDocument(Document?.FileName ?? string.Empty, DocMemoryStream);
        }
        ...
        public WmlDocument GetModifiedWmlDocument()
        {
            ...
            if (DocMemoryStream == null)
                throw new PowerToolsDocumentException("Memory stream is not available.");
            return new WmlDocument(Document?.FileName ?? string.Empty, DocMemoryStream);
        }

        // Commented out - not needed for DocumentAssembler
